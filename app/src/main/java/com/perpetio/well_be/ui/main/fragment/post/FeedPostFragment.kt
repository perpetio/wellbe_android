...
class FeedPostFragment : Fragment(), PostAdapter.FeedPostListener {

    private var _binding: FragmentFeedPostsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFeedPostsBinding.inflate(inflater, container, false)
        return binding.root
    }
